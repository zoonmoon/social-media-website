...
export default function LandingPageCard({blogPost}) {
  ...
  const deleteBlog = async (slug) => {
    ...
    try{
      setIsDeleting(true)
const response = await fetch('/api/admin/landing-pages/' + encodeURIComponent(slug), {
  method: 'DELETE',
});
  ...
  var href =  `/landing-pages/${encodeURIComponent(blogPost.slug)}`

    var editHref ='/admin/landing-pages/edit/'+encodeURIComponent(blogPost.slug)
