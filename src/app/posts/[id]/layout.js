...
//  console.log(post)
  ...
  if(post?.post?.media_type?.includes('image')){
    ...
    ogImage = thumbnail ? thumbnail :  'https://www.ArtyXpress.com/site-assets/og/ogmedia-video.jpg'
  }else if(post?.post?.media_type?.includes('audio')){
    ogImage = thumbnail ? thumbnail : 'https://www.ArtyXpress.com/site-assets/og/ogmedia-audio.jpg'
  }else if(post?.post?.media_type?.includes('application') || post?.post?.media_type?.includes('text')){
    ogImage = thumbnail ? thumbnail : 'https://www.ArtyXpress.com/site-assets/og/ogmedia-writtenword.jpg'
  }
  
  return {
    title: post?.post?.posted_by_name + ' shares on ArtyXpress.com',
